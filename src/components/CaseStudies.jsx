...
import { CASE_STUDIES_STATS, CASE_STUDIES_FEATURED_CARDS, CASE_STUDIES_CAMPAIGN_TYPES } from '../data'
      ...
      <div className="max-w-7xl mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-inglu-blue via-blue-600 to-blue-500">
        ...
        <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-16 lg:py-20 text-center">
          ...
          <h1 className="text-white font-black leading-tight text-3xl sm:text-4xl lg:text-5xl max-w-3xl mx-auto">
            Proof that communities move culture.
          </h1>

          <p className="mt-5 text-blue-50/90 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            From campus activations and creator campaigns to national youth engagement
            programs, see how brands achieved measurable outcomes through the INGLU ecosystem.
          </p>

          <div className="mt-8 flex flex-wrap justify-center gap-4">
            {/* YAHAN ERROR THI - MAINE ANCHOR TAG KO OPEN KAR DIYA HAI */}
            <a
              href="#content"
    ...
    <section className="px-4 lg:px-10 py-16 lg:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          ...
          heading="Nykaa x INGLU launched a Gen Z campus awareness campaign for a new beauty line."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {CASE_STUDIES_FEATURED_CARDS.map((card) => (
...
function CampaignTypesSection() {
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="Campaign types"
          heading="Repeatable formats with measurable outcomes."
          lead="One clear path for youth, campuses, creators and partners."
        />
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {CASE_STUDIES_CAMPAIGN_TYPES.map((card) => (
            <Card key={card.title} {...card} />
          ))}
        </div>
      </div>
