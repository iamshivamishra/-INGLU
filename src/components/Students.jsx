...
import { STUDENTS_STATS, STUDENTS_ADVANTAGE_CARDS, STUDENTS_E3_CARDS } from '../data'
      ...
      <div className="max-w-7xl mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-inglu-blue via-blue-600 to-blue-500">
        ...
        <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-16 lg:py-20 text-center">
          <span className="inline-block bg-white/15 border border-white/25 text-xs font-semibold tracking-wide text-white px-3 py-1.5 rounded-full mb-6">
            FOR STUDENTS · SINCE 2017
          </span>

          <h1 className="text-white font-black leading-tight text-3xl sm:text-4xl lg:text-5xl max-w-3xl mx-auto">
            Your college life just became worth something.
          </h1>

          <p className="mt-5 text-blue-50/90 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            Earn from the content you already make. Land real internships and paid
            brand collaborations. Build a network and a name that outlast your degree.
          </p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            >
              Join THE GRID <ArrowRight size={16} />
            </a>
            <Link
              to="/ecosystem"
  ...
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="At a glance"
          heading="Your college life just became worth something."
          lead="Earn from the content you already make. Land real internships and paid brand collaborations. Build a network and a name that outlast your degree."
        />
...
function AdvantageSection() {
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="The student advantage"
          heading="Six ways college starts paying you back."
          lead="The student advantage connects Internships, Brand collaborations and Networking into one clear path for youth, campuses, creators and partners."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {STUDENTS_ADVANTAGE_CARDS.map((card) => (
...
function E3Section() {
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="The E3 experience"
          heading="Experience equals Education plus Entertainment plus Enhancement."
          lead="The E3 experience connects Education, Entertainment and Enhancement into one clear path for youth, campuses, creators and partners."
        />
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {STUDENTS_E3_CARDS.map((card) => (
            <Card key={card.title} {...card} />
          ))}
        </div>
      </div>
