...
import { EVENTS_STATS, EVENTS_FEATURED_CARDS, EVENTS_FORMAT_CARDS } from '../data'

function Stat({ value, label }) {
  return (
    <div className="text-center">
      <strong className="block text-base sm:text-lg font-extrabold text-white leading-tight">{value}</strong>
      ...
      <div className="max-w-7xl mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-inglu-blue via-blue-600 to-blue-500">
        ...
        <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-16 lg:py-20 text-center">
          ...
          <h1 className="text-white font-black leading-tight text-3xl sm:text-4xl lg:text-5xl max-w-3xl mx-auto">
            Culture people show up for.
          </h1>

          <p className="mt-5 text-blue-50/90 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            Upcoming, live and past moments across FOMO, Ground Zero, campus festivals,
            workshops, creator meetups, artist showcases and brand activations.
          </p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            >
              Register for FOMO <ArrowRight size={16} />
            </a>
            ...
            >
              See calendar <ArrowRight size={16} />
            </Link>
          </div>
    ...
    <section className="px-4 lg:px-10 py-16 lg:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          ...
          heading="Premium event cards for upcoming, live and past formats."
        />
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {EVENTS_FEATURED_CARDS.map((card) => (
    ...
    <section className="px-4 lg:px-10 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          ...
          heading="Each event becomes a repeatable cultural product."
          lead="One clear path for youth, campuses, creators and partners."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {EVENTS_FORMAT_CARDS.map((card) => (
            <Card key={card.title} {...card} />
          ))}
        </div>
      </div>
