...
import { MUSE_STATS, MUSE_ROSTER_CARDS, MUSE_EXPERIENCE_CARDS } from '../data'
      ...
      <div className="max-w-7xl mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-inglu-blue via-blue-600 to-blue-500">
        ...
        <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-16 lg:py-20 text-center">
          ...
          <h1 className="text-white font-black leading-tight text-3xl sm:text-4xl lg:text-5xl max-w-3xl mx-auto">
            Where campus artists become movements.
          </h1>

          <p className="mt-5 text-blue-50/90 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            Muse Records is INGLU's label for emerging campus musicians, discovering
            student artists and turning live performances into the soundtrack of youth culture.
          </p>

          <div className="mt-8 flex flex-wrap justify-center gap-4">
            {/* Added missing opening <a> tag below */}
            <a
              href="#content"
            ...
            >
              Apply to Muse roster <ArrowRight size={16} />
            </a>
            <Link
              to="/ecosystem"
            ...
            >
              Book our artists <ArrowRight size={16} />
            </Link>
          </div>
  ...
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="The roster"
          heading="Emerging artists, real momentum."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {MUSE_ROSTER_CARDS.map((card) => (
...
function ExperiencesSection() {
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="Muse experiences"
          heading="More than music. A live culture."
          lead="One clear path for youth, campuses, creators and partners."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {MUSE_EXPERIENCE_CARDS.map((card) => (
            <Card key={card.title} {...card} />
          ))}
        </div>
      </div>
