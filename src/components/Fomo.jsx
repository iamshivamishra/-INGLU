...
import { FOMO_STATS, FOMO_MOMENT_WALL_CARDS, FOMO_MODULE_CARDS } from '../data'
      ...
      <div className="max-w-7xl mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-inglu-blue via-blue-600 to-blue-500">
        ...
        <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-16 lg:py-20 text-center">
          ...
          <p className="mt-5 text-blue-50/90 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            India's loudest youth events: founder talks, creator economy, hands-on
            workshops and a live show in one day on your campus.
          </p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            >
              Sponsor FOMO <ArrowRight size={16} />
            </Link>
          </div>
...
function MomentWallSection() {
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="The moment wall"
          heading="Scroll through the stuff people brag about."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FOMO_MOMENT_WALL_CARDS.map((card) => (
  ...
  return (
    <section className="px-4 lg:px-10 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <SectionHead
          kicker="FOMO modules"
          heading="A single day built like a cultural stack."
          lead="One clear path for youth, campuses, creators and partners."
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FOMO_MODULE_CARDS.map((card) => (
            <Card key={card.title} {...card} />
          ))}
        </div>
      </div>
